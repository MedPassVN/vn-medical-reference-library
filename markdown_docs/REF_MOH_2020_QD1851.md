...
* [1. ĐỊNH NGHĨA HEN PHẾ QUẢN](#1-định-nghĩa-hen-phế-quản)
* [2. CHẨN ĐOÁN](#2-chẩn-doán)
  * [2.1. Triệu chứng lâm sàng](#21-triệu-chứng-lâm-sàng)
  * [2.2. Cận lâm sàng](#22-cận-lâm-sàng)
  * [2.3. Chẩn đoán xác định](#23-chẩn-doán-xác-định)
    * [2.3.1. Hai đặc điểm cơ bản của HPQ](#231-hai-đặc-điểm-cơ-bản-của-hpq)
    * [2.3.2. Tiêu chuẩn chẩn đoán hen phế quản](#232-tiêu-chuẩn-chẩn-doán-hen-phế-quản)
    * [2.3.3. Các bước tiến hành để chẩn đoán HPQ](#233-các-bước-tiến-hành-để-chẩn-doán-hpq)
  * [2.4. Chẩn đoán phân biệt](#24-chẩn-doán-phân-biệt)
  * [2.5. Chẩn đoán hen phế quản khi bệnh nhân đã dùng thuốc kiểm soát hen](#25-chẩn-doán-hen-phế-quản-khi-bệnh-nhân-đã-dùng-thuốc-kiểm-soát-hen)
  * [2.6. Chẩn đoán hen phế quản ở một số thể lâm sàng](#26-chẩn-doán-hen-phế-quản-ở-một-số-thể-lâm-sàng)
  * [2.7. Đánh giá hen phế quản](#27-đánh-giá-hen-phế-quản)
    * [2.7.1. Đánh giá độ nặng của hen phế quản](#271-đánh-giá-độ-nặng-của-hen-phế-quản)
    * [2.7.2. Đánh giá kiểm soát hen](#272-đánh-giá-kiểm-soát-hen)
* [3. ĐIỀU TRỊ HEN PHẾ QUẢN](#3-điều-trị-hen-phế-quản)
  * [3.1. Các nguyên tắc của điều trị hen phế quản](#31-các-nguyên-tắc-của-điều-trị-hen-phế-quản)
    * [3.1.1. Mục tiêu dài hạn của điều trị hen](#311-mục-tiêu-dài-hạn-của-điều-trị-hen)
    * [3.1.2. Sự hợp tác giữa bệnh nhân – nhân viên y tế](#312-sự-hợp-tác-giữa-bệnh-nhân--nhân-viên-y-tế)
    * [3.1.3. Chu trình điều trị hen giúp giảm yếu tố nguy cơ và kiểm soát triệu chứng](#313-chu-trình-điều-trị-hen-giúp-giảm-yếu-tố-nguy-cơ-và-kiểm-soát-triệu-chứng)
  * [3.2. Thuốc điều trị và chiến lược kiểm soát triệu chứng và giảm nguy cơ](#32-thuốc-điều-trị-và-chiến-lược-kiểm-soát-triệu-chứng-và-giảm-nguy-cơ)
    * [3.2.1. Thuốc điều trị hen](#321-thuốc-điều-trị-hen)
    * [3.2.2. Điều trị ban đầu bằng thuốc kiểm soát hen](#322-điều-trị-ban-đầu-bằng-thuốc-kiểm-soát-hen)
    * [3.2.3. Điều chỉnh điều trị hen theo bậc](#323-điều-chỉnh-điều-trị-hen-theo-bậc)
    * [3.2.4. Quản lý các yếu tố nguy cơ thay đổi được khác](#324-quản-lý-các-yếu-tố-nguy-cơ-thay-đổi-được-khác)
    * [3.2.5. Các điều trị khác](#325-các-điều-trị-khác)
    * [3.2.6. Chỉ định chuyển tuyến trên để khám chuyên khoa](#326-chỉ-định-chuyển-tuyến-trên-để-khám-chuyên-khoa)
  * [3.3. Giáo dục xử trí hen theo hướng dẫn và huấn luyện kỹ năng](#33-giáo-dục-xử-trí-hen-theo-hướng-dẫn-và-huấn-luyện-kỹ-năng)
    * [3.3.1. Huấn luyện kỹ năng sử dụng hiệu quả các bình hít](#331-huấn-luyện-kỹ-năng-sử-dụng-hiệu-quả-các-bình-hít)
    * [3.3.2. Tuân thủ việc dùng thuốc và lời khuyên khác](#332-tuân-thủ-việc-dùng-thuốc-và-lời-khuyên-khác)
    * [3.3.3. Huấn luyện tự xử trí hen theo hướng dẫn](#333-huấn-luyện-tự-xử-trí-hen-theo-hướng-dẫn)
  * [3.4. Xử trí hen với bệnh lý đi kèm và trong những nhóm dân số đặc biệt](#34-xử-trí-hen-với-bệnh-lý-đi-kèm-và-trong-nhóm-dân-số-đặc-biệt)
    * [3.4.1. Xử trí bệnh lý đi kèm](#341-xử-trí-bệnh-lý-đi-kèm)
  * [3.5. Hen nặng ở bệnh nhân người lớn và vị thành niên](#35-hen-nặng-ở-bệnh-nhân-người-lớn-và-vị-thành-niên)
* [4. XỬ TRÍ KHI HEN TRỞ NẶNG VÀ ĐỢT CẤP](#4-xử-trí-khi-hen-trở-nặng-và-đợt-cấp)
  * [4.1. Đại cương](#41-đại-cương)
  * [4.2. Chẩn đoán đợt cấp hen phế quản](#42-chẩn-doán-đợt-cấp-hen-phế-quản)
  * [4.3. Hướng dẫn tự xử trí đợt cấp hen phế quản theo bản kế hoạch hành động](#43-hướng-dẫn-tự-xử-trí-đợt-cấp-hen-phế-quản-theo-bản-kế-hoạch-hành-động)
    * [Kế hoạch hành động hen phế quản](#kế-hoạch-hành-động-hen-phế-quản)
  * [4.4. Xử trí đợt cấp hen phế quản ở cơ sở chăm sóc sức khỏe ban đầu](#44-xử-trí-đợt-cấp-hen-phế-quản-ở-cơ-sở-chăm-sóc-sức-khỏe-ban-đầu)
  * [4.5. Xử trí đợt cấp hen phế quản tại khoa cấp cứu](#45-xử-trí-đợt-cấp-hen-phế-quản-tại-khoa-cấp-cứu)
...
| **FEV₁** | Forced Expiratory Volume in 1 second | Thể tích khí thở ra gắng sức trong 1 giây đầu tiên |
...
- **Khi đo với hô hấp ký:**
  ...
  - *Trường hợp đo trong cơn:* rối loạn thông khí (RLTK) tắc nghẽn phục hồi hoàn toàn với thuốc giãn phế quản: chỉ số FEV₁/FVC ≥ 75% sau hít 400µg salbutamol;
- **Sự biến đổi thông khí đo bằng lưu lượng đỉnh kế:**
  - Lưu lượng đỉnh (LLĐ) tăng >15% sau 30 phút hít 400µg salbutamol.
...
1. **Bệnh nhân có triệu chứng hô hấp**
   - **Triệu chứng có điển hình cho HPQ?**
     - **Không:** Hỏi thêm bệnh sử và làm thêm các thăm dò, không thấy có dấu hiệu chẩn đoán bệnh khác -> Xem xét chẩn đoán khác.
     - **Có:** Bệnh sử chi tiết / Khám lâm sàng cho HPQ.
2. **Bệnh sử / Khám lâm sàng ủng hộ chẩn đoán HPQ?**
   - **Không:** Xem xét chẩn đoán khác hoặc tình trạng cấp cứu.
   - **Có:** Đo CNTK phổi với test HPQ (hồi phục phế quản).
3. **Kết quả ủng hộ chẩn đoán HPQ?**
   - **Không:** Lặp lại lần khác hoặc chỉ định thăm dò khác. Nếu không cải thiện, điều trị thử nghiệm với ICS và SABA khi cần, đánh giá đáp ứng trong 1-3 tháng.
     - Nếu đáp ứng có hiệu quả -> Khẳng định chẩn đoán HPQ -> Điều trị HPQ.
     - Nếu không đáp ứng -> Xem xét điều trị bệnh lý có khả năng nhất, hoặc gửi bệnh nhân làm thêm các thăm dò khác -> Điều trị bệnh khác.
   - **Có:** Khẳng định chẩn đoán HPQ -> Điều trị HPQ.
...
| Đặc điểm chẩn đoán | Nội dung chi tiết |
| :--- | :--- |
| **1. Tiền sử có các triệu chứng hô hấp thay đổi** | Các triệu chứng điển hình là thở khò khè, khó thở, nặng ngực và ho.<br>- Người bị hen thường có nhiều hơn một trong các triệu chứng nêu trên;<br>- Các triệu chứng biến đổi theo thời gian và cường độ;<br>- Các triệu chứng thường xảy ra hoặc nặng hơn vào ban đêm hay lúc thức giấc;<br>- Các triệu chứng thường khởi phát khi gắng sức, cười lớn, tiếp xúc các dị nguyên hay không khí lạnh;<br>- Các triệu chứng thường xảy ra hoặc trở nên xấu đi khi nhiễm vi-rút. |
| **2. Bằng chứng giới hạn luồng khí thở ra biến đổi** | - Ít nhất một lần trong quá trình chẩn đoán có FEV₁ thấp, ghi nhận tỉ lệ FEV₁/FVC thấp hơn giá trị bình thường thấp. Tỉ lệ FEV₁/FVC bình thường lớn hơn 0,75 - 0,80 đối với người lớn và hơn 0,85 đối với trẻ em.<br>- Ghi nhận biến đổi chức năng hô hấp cao hơn ở người khỏe mạnh. Ví dụ:<br>  + FEV₁ tăng hơn 12% và 200mL so với giá trị ban đầu (ở trẻ em, >12% giá trị dự đoán) sau khi hít thuốc giãn phế quản. Được gọi là “giãn phế quản hồi phục”.<br>  + Trung bình hằng ngày LLĐ thay đổi >10% (ở trẻ em, >13%)<br>  + FEV₁ tăng hơn 12% và 200mL so với giá trị ban đầu (ở trẻ em, >12% giá trị dự đoán) sau 4 tuần điều trị bằng thuốc kháng viêm (ngoài các đợt nhiễm trùng hô hấp)<br>- Sự thay đổi vượt mức càng lớn trong nhiều lần đánh giá thì việc chẩn đoán HPQ càng chắc chắn hơn.<br>- Việc thăm dò nên được lặp lại trong khi có các triệu chứng, vào sáng sớm hay sau khi sử dụng các thuốc giãn phế quản.<br>- Hồi phục phế quản có thể không thấy trong đợt cấp nặng hay nhiễm vi-rút. Nếu hồi phục phế quản không thấy trong thăm dò chức năng hô hấp lần đầu, thì bước tiếp theo phụ thuộc vào tính cấp bách của lâm sàng và sự sẵn có của các thăm dò khác.<br>- Làm thêm các thăm dò khác để hỗ trợ chẩn đoán, bao gồm cả thử nghiệm gây co thắt phế quản. |
...
- **Các xét nghiệm khác:**
  - *Test kích thích phế quản:* dùng để đánh giá sự tăng tính phản ứng của đường thở. Các tác nhân kích thích bao gồm methacholine hít, histamine, vận động, tăng thông khí tự ý với CO₂ máu bình thường hoặc mannitol hít.
  - *Thử nghiệm dị ứng:* test lẩy da hoặc định lượng nồng độ immunoglobulin E (IgE) đặc hiệu trong huyết thanh với các dị nguyên hô hấp thông thường để phát hiện tình trạng quá mẫn với các dị nguyên này.
...
| :--- | :--- |
| **1. Đánh giá độ nặng của hen phế quản** | Mức độ nặng của hen được đánh giá hồi cứu từ mức điều trị cần thiết để kiểm soát triệu chứng và đợt cấp. |
| **2. Kiểm soát hen - đánh giá cả việc kiểm soát triệu chứng và yếu tố nguy cơ** | - Đánh giá việc kiểm soát triệu chứng trong vòng 4 tuần qua.<br>- Xác định các yếu tố nguy cơ khác dẫn đến kết cục xấu.<br>- Đo chức năng hô hấp trước khi bắt đầu điều trị, 3-6 tháng sau và định kỳ (ví dụ hàng năm). |
| **3. Có bệnh đồng mắc không** | - Bao gồm: Viêm mũi, viêm mũi xoang, trào ngược dạ dày thực quản (GERD), béo phì, hội chứng ngưng thở khi ngủ, trầm cảm, lo âu.<br>- Bệnh đồng mắc cần được phát hiện vì chúng có thể góp phần làm tăng các triệu chứng hô hấp, xuất hiện đợt cấp và làm giảm chất lượng cuộc sống. Điều trị bệnh đồng mắc có thể góp phần cải thiện kiểm soát hen. |
| **4. Vấn đề điều trị** | - Ghi lại điều trị của bệnh nhân và hỏi về tác dụng phụ.<br>- Quan sát bệnh nhân sử dụng bình xịt và kiểm tra kỹ thuật của họ.<br>- Thảo luận cởi mở và đồng cảm về tuân thủ điều trị.<br>- Kiểm tra bệnh nhân có bảng kế hoạch hành động cho hen.<br>- Hỏi người bệnh về thái độ và mục tiêu điều trị đối với bệnh hen của họ. |
...
#### A. Mức độ kiểm soát triệu chứng bệnh hen (trong 4 tuần qua)

| Triệu chứng lâm sàng | Kết quả | Đánh giá mức độ kiểm soát |
| :--- | :--- | :--- |
| **Triệu chứng ban ngày** $> 2$ lần/tuần? | Có □ / Không □ | **Kiểm soát hoàn toàn**: Không có tiêu chí nào "Có"<br><br>**Kiểm soát một phần**: Có 1 - 2 tiêu chí "Có"<br><br>**Không kiểm soát**: Có 3 - 4 tiêu chí "Có" |
...
*Đánh giá các yếu tố nguy cơ lúc chẩn đoán và định kỳ, đặc biệt với các bệnh nhân thường có đợt cấp. Đo FEV1 lúc bắt đầu điều trị, sau 3-6 tháng điều trị để ghi lại chức năng hô hấp tốt nhất, sau đó định kỳ để liên tục đánh giá nguy cơ.*

**1. Các yếu tố nguy cơ có thể thay đổi được làm tăng nguy cơ đợt cấp (ngay cả khi triệu chứng được kiểm soát tốt):**
*Lưu ý: Có triệu chứng hen không được kiểm soát là yếu tố nguy cơ quan trọng xuất hiện đợt cấp. Có một hoặc nhiều yếu tố nguy cơ dưới đây làm tăng nguy cơ đợt cấp.*
- **Thuốc**: ICS không được chỉ định; kém tuân thủ ICS; kỹ thuật hít không đúng; sử dụng SABA nhiều (nguy cơ tử vong tăng nếu dùng $\ge 1$ bình 200 liều/tháng, hoặc nguy cơ nhập viện tăng nếu dùng $\ge 3$ bình 200 liều/năm).
- **Bệnh đồng mắc**: Béo phì, viêm mũi mạn tính, GERD, dị ứng thức ăn, lo lắng, trầm cảm, có thai.
- **Phơi nhiễm**: Khói thuốc lá; tiếp xúc với dị nguyên; ô nhiễm không khí.
- **Tâm lý - Xã hội**: Có các vấn đề nghiêm trọng về tâm lý hoặc đời sống kinh tế - xã hội.
...
**2. Yếu tố nguy cơ độc lập quan trọng khác của đợt cấp:**
- Đã từng được đặt nội khí quản hoặc nhập khoa điều trị tích cực (ICU) do hen.
- Có từ 1 đợt cấp nặng trở lên trong 12 tháng qua.

**3. Yếu tố nguy cơ gây giới hạn luồng khí dai dẳng:**
- Sinh non, sinh nhẹ cân và tăng cân nhiều khi mới sinh.
- Không điều trị ICS đầy đủ.
- Tiếp xúc với khói thuốc lá, hóa chất độc hại, phơi nhiễm nghề nghiệp.
- FEV1 ban đầu thấp.
- Tăng tiết nhầy mạn tính.
- Tăng bạch cầu ái toan trong đờm hoặc máu.

**4. Yếu tố nguy cơ gây tác dụng phụ của thuốc:**
- **Toàn thân**: Dùng thường xuyên corticoid uống (OCS); ICS liều cao và/hoặc có hoạt tính mạnh kéo dài; dùng kèm thuốc ức chế P450.
...
Khi đã có chẩn đoán hen, theo dõi LLĐ ngắn hạn được sử dụng để đánh giá đáp ứng điều trị, xác định hen trở nặng. Sau điều trị ICS, LLĐ sẽ đạt mức trung bình sau 2 tuần, và tiếp tục tăng trong khoảng 3 tháng. Theo dõi LLĐ dài hạn thường áp dụng trong hen nặng; trên lâm sàng, chỉ số LLĐ giúp hỗ trợ trong tư vấn người bệnh.

#### b) Các đánh giá cần thiết cho bệnh nhân hen không được kiểm soát
Hầu hết bệnh nhân đạt kiểm soát hen tốt nhờ điều trị đúng, tránh yếu tố nguy cơ, và khám định kỳ. Tuy nhiên, vẫn có nhiều bệnh nhân không đạt được kiểm soát hen phế quản. Trong những trường hợp đó, cần tiến hành các thăm dò theo bảng dưới đây:

### Bảng 4. Các đánh giá cần thiết cho hen không được kiểm soát

| Lĩnh vực đánh giá | Hành động cụ thể |
| :--- | :--- |
| **Kỹ thuật hít và tuân thủ điều trị** | - Quan sát bệnh nhân sử dụng dụng cụ hít.<br>- So sánh kỹ thuật hít với bảng kiểm ống hít. Điều chỉnh các bước dùng sai; kiểm tra lại thường xuyên.<br>- Trao đổi cởi mở, đồng cảm về việc tuân thủ điều trị và những khó khăn khi sử dụng. |
| **Xác định lại chẩn đoán hen** | - Nếu chức năng hô hấp bình thường khi đang có triệu chứng, xem xét giảm nửa liều ICS và kiểm tra lại chức năng hô hấp sau 2-3 tuần. |
| **Loại bỏ yếu tố nguy cơ & kiểm soát bệnh đồng mắc** | - Kiểm tra các yếu tố nguy cơ hay nguyên nhân như hút thuốc, thuốc chẹn beta, thuốc chống viêm không steroid (NSAID), tiếp xúc dị nguyên.<br>- Kiểm tra và kiểm soát các bệnh đồng mắc như viêm mũi, béo phì, trào ngược dạ dày-thực quản (GERD), trầm cảm/lo lắng. |
| **Xem xét tăng bậc điều trị** | - Xem xét tăng bậc điều trị cho mức điều trị kế tiếp. Sử dụng chia sẻ quyết định và cân nhắc lợi ích cùng nguy cơ tiềm ẩn. |
| **Tham khảo ý kiến chuyên gia** | - Nếu hen vẫn không được kiểm soát sau 3-6 tháng điều trị theo bậc 4, tham khảo ý kiến chuyên gia hoặc các trung tâm chuyên điều trị hen nặng. Tham khảo sớm hơn nếu các triệu chứng hen nặng hay nghi ngờ về chẩn đoán. |
...
```mermaid
graph TD
    A["ĐÁNH GIÁ BỆNH NHÂN<br>- Chẩn đoán<br>- Kiểm soát triệu chứng & yếu tố nguy cơ<br>- Kỹ thuật hít & tuân thủ điều trị<br>- Ý kiến/mục tiêu của bệnh nhân"] --> B["ĐIỀU CHỈNH TRỊ LIỆU<br>- Thuốc điều trị hen<br>- Chiến lược không dùng thuốc<br>- Điều trị bệnh đồng mắc & yếu tố nguy cơ thay đổi được<br>- Hướng dẫn kỹ năng tự quản lý"]
    B --> C["ĐÁNH GIÁ ĐÁP ỨNG<br>- Triệu chứng<br>- Đợt cấp<br>- Tác dụng phụ<br>- Chức năng phổi<br>- Sự hài lòng của bệnh nhân"]
    C --> A
```
...
### Bảng 5. Khuyến cáo điều trị ban đầu bằng thuốc kiểm soát hen cho người lớn và trẻ $\ge 12$ tuổi

| Triệu chứng hiện tại | Điều trị ban đầu ưu tiên |
| :--- | :--- |
| **Tất cả bệnh nhân** | **Không khuyến cáo dùng SABA đơn thuần** (không có ICS) |
| **Triệu chứng hen $< 2$ lần/tháng** | - Liều thấp ICS/formoterol (khi cần) hoặc<br>- Liều thấp ICS mỗi khi dùng SABA khi cần |
| **Có triệu chứng hen $\ge 2$ lần/tháng** hoặc **phải dùng thuốc cắt cơn $\ge 2$ lần/tháng** | - Liều thấp ICS/formoterol (khi cần) hoặc<br>- Liều thấp ICS (hàng ngày) + SABA (khi cần) hoặc<br>- LTRA (hàng ngày, kém hiệu quả hơn ICS) + SABA (khi cần) |
| **Có triệu chứng hen hầu hết các ngày trong tuần** hoặc **thức giấc do triệu chứng hen $\ge 1$ lần/tuần**, đặc biệt nếu có bất kỳ yếu tố nguy cơ đợt cấp nào | - Liều thấp ICS/formoterol (vừa cắt cơn hen vừa kiểm soát hen) hoặc<br>- Liều thấp ICS/LABA (hàng ngày) + SABA (khi cần) hoặc<br>- Liều trung bình ICS + SABA khi cần<br>- ICS liều cao (hàng ngày) + Tiotropium (hàng ngày) hoặc LTRA (hàng ngày) + SABA (khi cần) |
| **Bệnh nhân đến khám lần đầu vì đợt cấp hen hoặc triệu chứng hen nặng** | - Một đợt corticoid uống trong 5-7 ngày + liều trung bình ICS/formoterol (hàng ngày) + liều thấp ICS/formoterol (khi cần).<br>- Một đợt corticoid uống trong 5-7 ngày + liều trung bình ICS/LABA (hoặc liều cao ICS) + SABA (khi cần) |

### Bảng 6. Liều ICS tương đương hàng ngày ở người lớn ($\mu$g)
...
| Phân loại | Bậc 1 | Bậc 2 | Bậc 3 | Bậc 4 | Bậc 5 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **THUỐC KIỂM SOÁT HEN ƯU TIÊN** | Liều thấp ICS/FOR khi cần | Liều thấp ICS mỗi ngày hoặc liều thấp ICS/FOR khi cần | Liều thấp ICS/LABA | Liều trung bình ICS/LABA | Liều cao ICS/LABA<br>Chuyển tuyến trên để đánh giá kiểu hình ± điều trị cộng thêm như Tiotropium, anti-IgE, anti-IL5, anti-IL5R, anti-IL4R |
...
| **THUỐC CẮT CƠN HEN ƯU TIÊN** | Liều thấp ICS/formoterol khi cần | Liều thấp ICS/formoterol khi cần | Liều thấp ICS/formoterol khi cần cho bệnh nhân dùng liệu pháp vừa duy trì và vừa cắt cơn trong một bình hít | Liều thấp ICS/formoterol khi cần cho bệnh nhân dùng liệu pháp vừa duy trì và vừa cắt cơn trong một bình hít | Liều thấp ICS/formoterol khi cần cho bệnh nhân dùng liệu pháp vừa duy trì và vừa cắt cơn trong một bình hít |
| **Thuốc cắt cơn hen khác** | SABA khi cần cho bệnh nhân đang dùng ICS hoặc ICS/LABA duy trì trong một bình hít riêng | SABA khi cần cho bệnh nhân đang dùng ICS hoặc ICS/LABA duy trì trong một bình hít riêng | SABA khi cần cho bệnh nhân đang dùng ICS hoặc ICS/LABA duy trì trong một bình hít riêng | SABA khi cần cho bệnh nhân đang dùng ICS hoặc ICS/LABA duy trì trong một bình hít riêng | SABA khi cần cho bệnh nhân đang dùng ICS hoặc ICS/LABA duy trì trong một bình hít riêng |

*Ghi chú:*
* **ICS:** corticoid dạng hít; **LABA:** đồng vận β2 tác dụng kéo dài; **SABA:** đồng vận β2 tác dụng ngắn; **LTRA:** kháng thụ thể Leukotriene; **FOR:** formoterol.
* Cân nhắc thêm liệu pháp miễn dịch giải mẫn cảm dưới lưỡi (SLIT) ở những người bệnh hen nhạy cảm với mạt nhà kèm viêm mũi dị ứng và FEV1 > 70% dự đoán.

#### Chọn liệu pháp điều trị hen:
Tại mỗi bậc điều trị hen, có vài loại thuốc kiểm soát hen khác nhau, tuy hiệu quả không giống nhau, tùy bác sĩ lựa chọn. Thuốc kiểm soát hen ưu tiên là thuốc được khuyến cáo cho phần lớn bệnh nhân hen vì chúng đã được chứng minh hiệu quả trong kiểm soát triệu chứng và giảm nguy cơ đợt cấp qua các thử nghiệm lâm sàng. Tuy nhiên, việc lựa chọn thuốc kiểm soát hen nào cho từng bệnh nhân còn phải xem xét các yếu tố khác như: thuốc có sẵn, giá thành, khả năng sử dụng bình hít tương ứng, khả năng tuân thủ điều trị với thuốc đó, khả năng đáp ứng với thuốc và thói quen của bệnh nhân.
...
Giảm bậc khi hen phế quản đã đạt được kiểm soát tốt và duy trì ổn định trong 3 tháng. Việc giảm bậc nhằm tìm liều ICS thấp nhất (liều hiệu quả tối thiểu) mà vẫn đảm bảo kiểm soát cả triệu chứng và đợt cấp, đồng thời giảm tác dụng phụ. Một số lưu ý:
- Chọn thời điểm thích hợp để giảm bậc (không nhiễm trùng hô hấp, không đi du lịch, không có thai) khi thời tiết thuận lợi.
...
| Bậc hiện tại | Loại và liều thuốc kiểm soát hen hiện tại | Lựa chọn giảm bậc |
| :--- | :--- | :--- |
...
| **Bậc 2** | Liều thấp ICS | - Chuyển sang liều thấp ICS/formoterol khi cần<br>- Giảm 50% liều ICS/ngày hoặc dùng cách ngày<br>- Chuyển sang liều hiệu quả tối thiểu của ICS với SABA khi cần |
| | ICS liều thấp hoặc montelukast | - Chuyển sang liều thấp ICS/formoterol khi cần<br>- Chuyển sang liều hiệu quả tối thiểu ICS/formoterol (giảm còn 1 lần cách ngày đến 1 lần/tuần)<br>- Montelukast và ICS liều hiệu quả tối thiểu (giảm còn 1 lần cách ngày đến 1 lần/tuần) |
...
* **Bệnh nhân có ít nhất 1 đợt cấp hen trong năm qua:** Dùng liệu pháp điều trị hen phù hợp để giảm thiểu đợt cấp như liệu pháp liều thấp ICS/formoterol vừa duy trì vừa cắt cơn trong một bình hít; hoặc tăng bậc điều trị nếu không có yếu tố nguy cơ có thể thay đổi được.
* **Bệnh nhân có FEV1 thấp:** Thử liều cao ICS trong 3 tháng. Lưu ý loại trừ bệnh phổi khác như COPD, giãn phế quản.
...
Chương trình huấn luyện tự xử trí hen theo hướng dẫn hiệu quả sẽ giúp giảm sử dụng dịch vụ y tế khẩn cấp, cải thiện mức độ kiểm soát hen, có thể áp dụng cho các đối tượng và tình huống khác nhau, nhưng không làm tăng chi phí điều trị hen.
...
**Hình ảnh liên quan:**
- **Hình 3. Chẩn đoán và điều trị hen nặng ở người lớn và trẻ em ≥ 12 tuổi** (bao gồm ba hình dưới đây: 3.1, 3.2 và 3.3):
  - **Hình 3.1. Đánh giá và xử trí hen khó điều trị ở người lớn và trẻ em ≥ 12 tuổi**
  - **Hình 3.2. Đánh giá và điều trị kiểu hình hen nặng**
  - **Hình 3.3. Đánh giá và điều trị kiểu hình hen nặng (tiếp)**
...
- Xem xét liệu pháp bổ sung không dùng thuốc: Cai thuốc lá, tập thể dục, chế độ ăn uống lành mạnh, giảm cân, làm sạch chất nhầy, tiêm phòng cúm, tập thở, tránh dị nguyên cho người bệnh mẫn cảm và tránh phơi nhiễm nếu có thể.
...
- Sắp xếp lịch khám để đánh giá đáp ứng với các can thiệp trên. Thời điểm thăm khám phụ thuộc vào mức độ khẩn cấp lâm sàng và những thay đổi đối với điều trị đã được thực hiện.
...
###### Điều trị bổ sung anti-IgE cho hen dị ứng nặng
...
- **Chỉ định được phê duyệt**:
  - Cho người bệnh ≥ 12 tuổi: Mepolizumab (anti-IL5) 100mg tiêm dưới da 4 tuần một lần và benralizumab* (anti-IL5R) tiêm dưới da 30mg mỗi 4 tuần trong 3 liều, sau đó mỗi 8 tuần.
  - Cho người bệnh ≥ 18 tuổi: Reslizumab* (anti-IL5) 3mg/kg truyền tĩnh mạch mỗi 4 tuần.
...
-   **Cơ chế:** liên kết với thụ thể α IL-4, chặn cả tín hiệu IL-4 và IL-13.
-   **Tiêu chuẩn phù hợp để được chỉ định:**
...
-   Đánh giá đáp ứng của người bệnh với liệu pháp sinh học bổ sung sau 3-4 tháng và mỗi 3-6 tháng sau đó, bao gồm các vấn đề sau:
...
#### Định nghĩa đợt cấp hen phế quan

-   **Đợt cấp hen phế quản** là sự xuất hiện nặng lên của các triệu chứng khó thở, ho, khò khè, nặng ngực và giảm chức năng thông khí (CNTK) phổi. Đợt cấp có thể xảy ra ở bệnh nhân đã được chẩn đoán hen hoặc đôi khi, như là biểu hiện đầu tiên của hen.
...
#### Các yếu tố làm gia tăng nguy cơ tử vong có liên quan đến hen

Bệnh nhân có các dấu hiệu sau có thể làm gia tăng nguy cơ tử vong do hen, và do vậy cần được đánh giá thường xuyên:
...
#### Bảng: Thay đổi thuốc trong kế hoạch hành động hen khi bệnh trở nặng

| Phân loại | Thuốc hiện tại | Thay đổi ngắn hạn (1-2 tuần) đối với hen trở nặng | Mức chứng cứ |
| :--- | :--- | :--- | :--- |
| **SỚM HOẶC NHẸ**<br>*(Tăng thuốc giảm triệu chứng thường ngày)* | **ICS liều thấp/formoterol*** | Tăng tần số sử dụng thuốc giảm triệu chứng (tổng liều formoterol tối đa 72 mcg/ngày) | A |
| | **Kích thích beta 2 tác dụng ngắn (SABA)** | Tăng tần số sử dụng SABA. Đối với pMDI, bổ sung buồng đệm. | A |
| **SỚM HOẶC NHẸ**<br>*(Tăng thuốc kiểm soát thường ngày)* | **Thuốc duy trì và giảm triệu chứng ICS/formoterol*** | Tiếp tục ICS duy trì/formoterol và tăng thuốc giảm triệu chứng ICS/formoterol theo nhu cầu* (tổng liều formoterol tối đa 72 mcg/ngày) | A |
| | **ICS duy trì với SABA là thuốc giảm triệu chứng** | Ở người lớn và trẻ vị thành niên: Gấp 4 lần liều ICS.<br>Ở trẻ em: Tăng gấp 5 lần liều ICS không hiệu quả (đối với trẻ tuân thủ điều trị). | B |
| | **ICS/formoterol duy trì với SABA là thuốc giảm triệu chứng** | Gấp 4 lần ICS/formoterol duy trì (tổng liều formoterol tối đa 72 mcg/ngày) | B |
| | **ICS duy trì/salmeterol với SABA là thuốc giảm triệu chứng** | Nâng bậc đến liều cao hơn ICS/salmeterol hoặc xem xét thêm một ống hít ICS riêng lẻ đến gấp 4 lần liều ICS | D |
| **TRỄ HOẶC NẶNG**<br>*(Thêm corticoid đường uống - OCS và gặp bác sĩ tư vấn)* | **Thêm OCS đối với cơn kịch phát nặng** | Thêm OCS đối với cơn kịch phát nặng (PEF hoặc FEV1 < 60% trị số cá nhân tốt nhất hoặc dự đoán), hoặc bệnh nhân không đáp ứng với điều trị qua 48 giờ. | A |
| | **OCS (prednisone hoặc prednisolone)** | - **Người lớn:** Prednisolone 1mg/kg/ngày (tối đa 50 mg) thường trong 5-7 ngày.<br>- **Trẻ em:** 1-2 mg/kg/ngày (tối đa 40 mg) thường trong 3-5 ngày. | D |
| | | Giảm liều OCS không cần thiết nếu được kê toa trong < 2 tuần. | B |

*\*Hình 7.4. Kế hoạch hành động hen*

Tất cả các bệnh nhân hen phế quản (HPQ) đều cần có kế hoạch hành động hen phù hợp với mức độ nặng và tình trạng sức khỏe chung để bệnh nhân có thể tự phát hiện, xử trí khi xuất hiện tình trạng bệnh nặng hơn.  
...
-   Bệnh nhân nên đến khám bác sĩ, hoặc tư vấn nhân viên y tế sau khi đã xử trí đợt cấp để:
...
-   **Sắp xếp chuyển bệnh nhân tới cơ sở cấp cứu:** ngay khi có dấu hiệu nặng của đợt cấp, hoặc chuyển ngay tới khoa hồi sức khi có dấu hiệu nguy kịch: vật vã, kích thích, ngủ gà, phổi im lặng. Với những bệnh nhân này: cần khí dung SABA, ipratropium bromide, thở oxy, corticoid toàn thân ngay trước khi chuyển viện.
-   **Bắt đầu điều trị:**
...
| Tiêu chí | Nhẹ hoặc Trung bình | Nặng | Đe dọa tử vong |
| :--- | :--- | :--- | :--- |
| **Triệu chứng lâm sàng** | - Nói từng cụm từ, thích ngồi hơn nằm, không kích động.<br>- Nhịp thở tăng.<br>- Không sử dụng cơ hô hấp phụ.<br>- Nhịp tim: 100-120 lần/phút.<br>- SpO2 (không khí phòng): 90-95%.<br>- LLĐ > 50% dự đoán hoặc tốt nhất. | - Nói từng từ, ngồi khom phía trước, kích động.<br>- Nhịp thở > 30/phút.<br>- Cơ hô hấp phụ co kéo.<br>- Nhịp tim > 120 lần/phút.<br>- SpO2 (không khí phòng) < 90%.<br>- LLĐ ≤ 50% dự đoán hoặc tốt nhất. | - Buồn ngủ, lẫn lộn hoặc ngực im lặng. |
| **Bắt đầu điều trị** | - **SABA:** 4-10 nhát qua pMDI + buồng hít, lặp lại mỗi 20 phút trong 1 giờ.<br>- **Prednisolone:** Người lớn 1 mg/kg (tối đa 50 mg), trẻ em 1-2 mg/kg (tối đa 40 mg). Xem xét ICS phun hít, khí dung (nếu có).<br>- **Oxy có kiểm soát:** Độ bão hòa mục tiêu 93-95% (trẻ em: 94-98%). | **CHUYỂN ĐẾN CƠ SỞ CHĂM SÓC CẤP CỨU**<br>Trong khi chờ chuyển: Cho SABA, oxy, corticosteroid toàn thân. | **CHUYỂN ĐẾN CƠ SỞ CHĂM SÓC CẤP CỨU**<br>Trong khi chờ chuyển: Cho SABA, oxy, corticosteroid toàn thân. |
| **Đánh giá đáp ứng sau 1 giờ** | - **Cải thiện:** Đánh giá cho về.<br>- **Trở nặng:** Chuyển đến cơ sở chăm sóc cấp cứu. | - | - |

**Đánh giá để cho về (Trường hợp cải thiện):**
- Triệu chứng cải thiện, không cần dùng SABA thường xuyên.
- LLĐ cải thiện và > 60-80% tốt nhất của cá nhân hoặc dự đoán.
- Độ bão hòa oxy > 94% khi thở không khí phòng.
- Nguồn lực chăm sóc tại nhà đầy đủ.

**Đơn thuốc điều trị ngoại trú:**
- **Thuốc giảm triệu chứng:** Tiếp tục theo nhu cầu.
- **Thuốc kiểm soát:** Bắt đầu hoặc nâng bậc điều trị.
- **Prednisolone:** Tiếp tục dùng, thường trong 5-7 ngày (3-5 ngày đối với trẻ em).
- **Theo dõi:** Trong vòng 2-7 ngày.

**Kế hoạch theo dõi sau đó:**
- **Thuốc giảm triệu chứng:** Giảm đến mức theo nhu cầu.
- **Thuốc kiểm soát:** Tiếp tục dùng liều cao hơn trong ngắn hạn (1-2 tuần) hoặc dài hạn (3 tháng) tùy theo nguyên nhân cơn cấp.
- **Yếu tố nguy cơ:** Kiểm soát và điều chỉnh các yếu tố nguy cơ thay đổi được vốn có thể góp phần vào cơn cấp, bao gồm kỹ thuật hít thuốc và tuân thủ điều trị.
- **Kế hoạch hành động:** Đánh giá xem bệnh nhân có hiểu và sử dụng phù hợp không, có cần thay đổi không.
...
Đợt cấp hen phế quản nặng là cấp cứu đe dọa tử vong, được xử trí an toàn nhất tại khoa cấp cứu của cơ sở chăm sóc cấp cứu.

#### Bảng 10. Xử trí đợt cấp hen phế quản tại khoa cấp cứu

**1. Đánh giá ban đầu:**
Xem xét sự xuất hiện của bất kỳ triệu chứng nguy kịch nào sau đây:
-   **A (Đường dẫn khí - Airway)**
-   **B (Hô hấp - Breathing)**
-   **C (Tuần hoàn - Circulation)**
-   **Dấu hiệu đe dọa tử vong:** Lơ mơ, lẫn lộn, ngực im lặng.
    -   **CÓ:** Hội chẩn ICU, bắt đầu SABA và O2, và chuẩn bị đặt nội khí quản.
    -   **KHÔNG:** Tiếp tục phân loại tùy tình trạng lâm sàng theo tính chất xấu nhất (Nhẹ hoặc Trung bình vs. Nặng).

**2. Phân loại lâm sàng và điều trị ban đầu:**

| Tiêu chí / Điều trị | Nhẹ hoặc Trung bình | Nặng |
| :--- | :--- | :--- |
| **Triệu chứng & Dấu hiệu** | - Nói từng cụm từ<br>- Thích ngồi hơn nằm<br>- Không kích động<br>- Nhịp thở tăng<br>- Không sử dụng cơ hô hấp phụ<br>- Nhịp tim: 100-120 lần/phút<br>- SpO2 (không khí phòng): 90-95%<br>- LLĐ > 50% dự đoán hoặc tốt nhất của cá nhân | - Nói từng từ<br>- Ngồi khom phía trước<br>- Kích động<br>- Nhịp thở > 30/phút<br>- Cơ hô hấp phụ co kéo<br>- Nhịp tim > 120 lần/phút<br>- SpO2 (không khí phòng) < 90%<br>- LLĐ ≤ 50% dự đoán hoặc tốt nhất của cá nhân |
| **Điều trị ban đầu** | - Thuốc đồng vận beta 2 tác dụng ngắn (SABA)<br>- Xem xét ipratropium bromide<br>- Oxy có kiểm soát để duy trì độ bão hòa 93-95% (trẻ em: 94-98%)<br>- Corticosteroid uống<br>- Xem xét corticosteroid khí dung liều cao | - Thuốc đồng vận beta 2 tác dụng ngắn (SABA)<br>- Xem xét ipratropium bromide<br>- Oxy có kiểm soát để duy trì độ bão hòa 93-95% (trẻ em: 94-98%)<br>- Corticosteroid uống hoặc tiêm tĩnh mạch<br>- Xem xét magnesium tĩnh mạch<br>- Xem xét corticosteroid khí dung liều cao |

*Lưu ý: Nếu tiếp tục diễn tiến xấu, điều trị như nặng và tái đánh giá để chuyển ICU.*

**3. Đánh giá diễn tiến lâm sàng thường xuyên:**
-   Đo chức năng phổi (FEV1 hoặc LLĐ) trên tất cả bệnh nhân 1 giờ sau khi điều trị ban đầu.

**4. Phân loại sau 1 giờ điều trị và hướng xử trí:**
-   **Trung bình (FEV1 hoặc LLĐ ≥ 60-80% dự đoán hoặc tốt nhất của cá nhân và triệu chứng cải thiện):**
    -   Xem xét kế hoạch cho ra viện.
-   **Nặng (FEV1 hoặc LLĐ < 60% dự đoán hoặc tốt nhất của cá nhân, hoặc thiếu đáp ứng lâm sàng):**
    -   Tiếp tục điều trị như trên và tái đánh giá thường xuyên.

**Ký hiệu viết tắt:**
*   **ICS:** Corticosteroid dạng khí dung, dạng hít xịt.
*   **ICU:** Khoa săn sóc đặc biệt (Hồi sức tích cực).
*   **IV:** Tiêm tĩnh mạch.
*   **O2:** Oxy.
*   **LLĐ:** Lưu lượng thở ra đỉnh.
*   **FEV1:** Thể tích thở ra gắng sức 1 giây đầu.

#### Điều trị khác

Ngoài những điều trị nêu trên, cần quan tâm tới một số điều trị sau trong trường hợp bệnh nhân đáp ứng kém hoặc không đáp ứng với điều trị:
...
-   **Thuốc kháng thụ thể leukotriene:** Hầu như ít được sử dụng trong đợt cấp hen phế quản. Chỉ định điều trị khi bệnh nhân ổn định, ra viện, và thường dùng kèm với ICS.
-   **Kết hợp ICS/LABA:** Không có nhiều vai trò trong điều trị đợt cấp hen phế quản. Tuy nhiên, có thể dùng ngay khi bệnh nhân nằm viện để đánh giá kỹ năng dùng thuốc của bệnh nhân, bảo đảm khi bệnh nhân ra viện đã quen và dùng đúng thuốc.
...
-   **Đánh giá đáp ứng điều trị:** Đánh giá thường xuyên đáp ứng lâm sàng, SpO2. Có thể đo chức năng thông khí phổi khi bệnh nhân đã tương đối ổn định. Trường hợp bệnh nhân có diễn biến nặng: chuyển khoa điều trị tích cực.

### Bảng 11. Xử trí xuất viện từ khoa cấp cứu

| Nội dung | Hướng dẫn xử trí |
| :--- | :--- |
| **Thuốc** | |
| - Corticosteroid uống (OCS) | Tổng thời gian dùng OCS: 5-7 ngày với người lớn (prednisolone hoặc tương đương 1 mg/kg/ngày tới tối đa 50 mg/ngày) và 3-5 ngày đối với trẻ em (1-2 mg/kg/ngày tới tối đa 40 mg). |
| - Thuốc cắt cơn | Dùng thuốc cắt cơn (SABA hoặc ICS/formoterol) khi bệnh nhân có cơn khó thở. |
| - Corticosteroid dạng hít, xịt, khí dung (ICS) | Bắt đầu ICS hoặc ICS/LABA trước khi xuất viện. Tư vấn kỹ cách dùng thuốc dạng phun hít. |
| **Loại bỏ yếu tố nguy cơ đợt cấp** | Xác định các yếu tố có thể đã góp phần vào đợt cấp; Tránh, loại bỏ các yếu tố gây đợt cấp hen phế quản: khói thuốc, bụi, các mùi nồng gắt, lông súc vật (chó, mèo...), nhiễm trùng đường hô hấp. |
| **Kỹ năng tự xử trí và bản kế hoạch hành động hen** | - Đánh giá lại kỹ thuật hít thuốc.<br>- Đánh giá lại kỹ thuật sử dụng lưu lượng đỉnh kế (nếu có).<br>- Xây dựng bản kế hoạch hành động hen phế quản hoặc xem lại bản kế hoạch hiện có của bệnh nhân, lúc xuất viện.<br>- Đánh giá khả năng xử trí của bệnh nhân đối với đợt cấp.<br>- Điều chỉnh kế hoạch hành động hen nếu cần.<br>- Xem lại thuốc kiểm soát hen của bệnh nhân. Các thay đổi khi xuất hiện đợt cấp. Khả năng dùng thêm corticoid đường toàn thân. |
| **Hẹn tái khám theo dõi** | Hẹn tái khám theo dõi trong vòng 2-7 ngày sau xuất viện nếu tình trạng bệnh chưa thực sự ổn định. |
...
- **Đơn thuốc khi về nên bao gồm**:
  - Thuốc cắt cơn khi cần.
  - Corticoid uống: prednisolone uống 1 mg/kg/ngày tới tối đa 50 mg/ngày hoặc tương đương, thường trong 5-7 ngày. Nếu dùng dexamethasone, thời gian dùng chỉ 1-2 ngày.
...
1. Global initiative for asthma: Pocket guide for asthma management and prevention (for adults and children older than 5 years). Updated 2019.
